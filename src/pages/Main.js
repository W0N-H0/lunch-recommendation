...
border-radius: 15px;
border: 3px solid black;
background: linear-gradient(177deg, rgba(255, 39, 0, 0.38) 0%, rgba(234, 133, 115, 0.00) 100%), #FFF2E9;
display: flex;
flex-direction: column;
align-items: center;
 justify-content: space-evenly;
            ...
            <Container>
                ...
                <TopBarWrap>
                    ...
                    <AcctionBtnWrap>
                        ...
                        {/* 방향키 */}
                        <AcctionBtn><AcctionImg src="/images/left-btn.png" alt="back button" /></AcctionBtn>
                        <AcctionBtn><AcctionImg src="/images/right-btn.png" alt="next button" /></AcctionBtn>
                    </AcctionBtnWrap>
                    ...
                    <LinkWrap>
                        ...
                        <AcctionBtn><AcctionImg src="/images/btn.png" alt="reflash button" /></AcctionBtn>
                    </LinkWrap>
                ...
                {/* 상단바-2 */}
                <SecondBarWrap>
                    <MapBtn> <MapText> 지역구 보러가기 </MapText> </MapBtn>
                </SecondBarWrap>
                ...
                <MainWrap>
                    ...
                    <MainGame>
                        ...
                        <MainGameBtnWram>
                            <MapModal>
                                <MapInnerText>지역선택</MapInnerText>
                            </MapModal>
                            <StartClick><StartText>Click!</StartText></StartClick>
                            <MapSearch>
                                <MapInnerText>지역구 입력</MapInnerText>
                            </MapSearch>
                        </MainGameBtnWram>
